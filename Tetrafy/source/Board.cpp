...
Board::Board(Vec2<int32_t> pos, Vec2<int32_t> gridSize, int32_t cellSize, int32_t cellPadding)
	...
	m_ScoreGUIComponent({ pos.GetX() + gridSize.GetX() * (cellSize + cellPadding) + 5 * cellPadding, static_cast<int>(50.f * Globals::Options.GUIScale + 287.f * Globals::Options.GUIScale + 5.f * cellPadding) }, { static_cast<int>(196 * Globals::Options.GUIScale), static_cast<int>(75.f * Globals::Options.GUIScale) }),
	m_LevelGUIComponent({ {pos.GetX() + gridSize.GetX() * (cellSize + cellPadding) + 5 * cellPadding, static_cast<int>(50.f * Globals::Options.GUIScale + 287.f * Globals::Options.GUIScale + 5.f * cellPadding + 75.f * Globals::Options.GUIScale + 5 * cellPadding)}, {static_cast<int>(196.f * Globals::Options.GUIScale), static_cast<int>(75.f * Globals::Options.GUIScale)} }),
	m_HeldTetrominoGUIComponent({ {pos.GetX() + gridSize.GetX() * (cellSize + cellPadding) + 5 * cellPadding, static_cast<int>(50.f * Globals::Options.GUIScale + 287.f * Globals::Options.GUIScale + 5.f * cellPadding + 75.f * Globals::Options.GUIScale + 5 * cellPadding + 75.f * Globals::Options.GUIScale + 5 * cellPadding)}, {static_cast<int>(196.f * Globals::Options.GUIScale), static_cast<int>(130*Globals::Options.GUIScale)}, this->m_HeldTetromino }),
	m_LinesClearedGUIComponent({ {pos.GetX() + gridSize.GetX() * (cellSize + cellPadding) + 5 * cellPadding, static_cast<int>(50.f * Globals::Options.GUIScale + 287.f * Globals::Options.GUIScale + 5.f * cellPadding + 75.f * Globals::Options.GUIScale + 5 * cellPadding + 75.f * Globals::Options.GUIScale + 5 * cellPadding + 130.f * Globals::Options.GUIScale)}, {static_cast<int>(196.f * Globals::Options.GUIScale), static_cast<int>(75.f * Globals::Options.GUIScale)} })
{
